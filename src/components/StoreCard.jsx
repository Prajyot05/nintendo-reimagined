...
export function StoreCard({num, text}) {
  return (
    <CardContainer className="inter-var">
      <CardBody className="bg-[#F0F1F1] bg-opacity-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-[30px] p-6 border  ">
