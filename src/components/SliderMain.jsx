  ...
  return (
    <div className="content absolute z-10 top-[10vh] w-full h-screen hidden">
          <div className="slider-info-container flex gap-10 items-start justify-between p-10 font-bold opacity-0">
            ...
            <div className="slider-main-right flex flex-col items-center gap-10 w-[60%] text-white">
              ...
              <div className="direct-download-container flex gap-10">
                <div className='direct-download-btn w-fit flex items-center px-16 rounded-3xl bg-red-500 hover:bg-red-600 transition-colors ease-in-out duration-200'>
                  ...
                  <h3 className='text-3xl'>Direct Download</h3>
                </div>
                <div className='esrb'>
